package com.jjcdutra.forum.exception

import com.jjcdutra.forum.dto.ErrorView
...
class ExceptionHandler {
    ...
    fun handlerValidError(exception: MethodArgumentNotValidException, request: HttpServletRequest): ErrorView {
