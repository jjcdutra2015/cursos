...
import com.github.jjcdutra2015.escola.academico.dominio.aluno.*;
...
public class RepositorioDeAlunoComJDBC implements RepositorioDeAluno {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                while (rsTelefone.next()) {
                    ...
                    String numero = rsTelefone.getString("ddd");
